...
if __name__ == '__main__':
    ...
    for temp_code in code_list:
        time.sleep(1)
        download = DownloadHistoryStock(temp_code)
        download.run()
# ————————————————
# 版权声明：本文为CSDN博主「PythonCodeZ」的原创文章，遵循 CC 4.0 BY-SA 版权协议，转载请附上原文出处链接及本声明。
# 原文链接：https://blog.csdn.net/PythonCodeZ/article/details/77623287